...
```
H_0: We are sampling the differentially expressed diabetes genes at random from the distribution of all differentially expressed genes , i.e. The diabetes genes are not overexpressed in the differentially expressed gene set
H_a: We are sampling more diabetes genes from the differentiallyexpressed genes than by expected by chance , i.e. The diabetes genes are overrepresented in the differentially expressed genes.

The chance of this drawing 31 diabtese genes is 0.63 which is much higher than our significance threshold therefore the diabetes genes were sampled randomly.
...
H_0: The mean of the diaebtes genes distribution is the same as or lower than the mean of the distribution of all other genes, i.e. the diabetes genes occur in the differentially expressed gene list by chance.
H_1: The mean of the diabetes gene is greater than all other genes, i.e. the diabtes genes are overrepresented in the differentially expressed gene list.

We get a pvalue of 0.2 which is more than the significance threshold so we cannot reject the null hypothesis, so we must accept that the diabetes genes are up/down regulated by chance.
